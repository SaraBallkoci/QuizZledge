...
<body id="new-quizz">
    ...
    <div class="container mt-4 space">
        ...
        <div class="d-flex justify-content-between mt-3">
            ...
            <button class="btn btn-primary" id="finishCreation" >Finish Quiz Creation</button>
        </div>
    </div>
    ...
    <div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmationModalLabel">Quiz added successfully!</h5>
                ...
                <div class="modal-body">
                    <div class="input-group">
                        <input type="text" class="form-control" id="quizLink" readonly>
                ...
                <div class="modal-footer">
                    <button type="button" id="finalisationCreation" class="btn btn-secondary" data-bs-dismiss="modal">Go to list of created quizzes</button>
                </div>
            </div>
        </div>
    </div>
